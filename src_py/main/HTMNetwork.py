...
def createEncoder():
  ...
  series_rdse = RandomDistributedScalarEncoder(0.001, name="rdse with resolution 0.001")
...
def createNetwork(datasource, cellsPerMiniColumn=32):
  ...
  TM_PARAMS["cellsPerColumn"] = cellsPerMiniColumn
...
if __name__ == "__main__":
  ...
  dataSource = TimeSeriesStream(time_series_model)

  network = createNetwork(dataSource, cellsPerMiniColumn=32)
  network.initialize()
