...
\footnotetext{Image (b) courtesy of Seattle Weather Blog: \href{http://www.seattleweatherblog.com/rain-stats/}{\texttt{http://www.seattleweatherblog.com/rain-stats/}} }
	...
	\noindent just as with the autoregressive model, we have $q+2$ unknown paramters and the model can be written more succinctly using the backshift operator yielding $\tilde{z}_{t}=\theta(B)a_{t}$~\cite{Box}.
