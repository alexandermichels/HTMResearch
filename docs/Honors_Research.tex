...
\footnotetext{Image (b) courtesy of Seattle Weather Blog: \href{http://www.seattleweatherblog.com/rain-stats/}{\texttt{http://www.seattleweatherblog.com/rain-stats/}} }
    ...
    \section{Swarming for Parameter Optimization}
    ...
    \section{Fitting Coefficients of Time Series}
	...
	\begin{table}[!ht]
		...
		\begin{tabular}{|l|c|c|c|c|l|}
			...
			\cellcolor{black} & $\mu_{diff}$ & $\sigma_{diff}$ & $\mu_{diff}$ & $\sigma_{diff}$ & \cellcolor{black}         \\ \hline
		...
		\end{tabular}
		\caption{Errors on fitting coefficients to instances of Lag-6 AR and MA models}
    ...
    \section{Evaulating HTM Predictions}
    ...
    \textcolor{red}{talk about theory behind all this}
