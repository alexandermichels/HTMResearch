\documentclass[fleqn,notitlepage,minimal]{article}
...
\begin{document}
	...
	\begin{thebibliography}{99}
		...
		\bibitem{RDSE} Fergal Byrne. 2014. Random Distributed Scalar Encoder. (July 18, 2014). Retrieved August 27, 2014 from http://fergalbyrne.github.io/rdse.html
		...
		\bibitem{HTM School} HTM School. Scalar Encoding (Episode 5). Video. (June 10, 2016). Retrieved August 24, 2018 from  https://www.youtube.com/watch?v=V3Yqtpytif0
		...
		\bibitem{Semantic} De Sousa Webber, F. E. \textit{Semantic Folding: Theory and its Application in Semantic Fingerprinting}. Cortical.io, Vienna, 2016.
